...
public interface VideoListener {
   ...
   * renderer will apply all necessary rotations internally. On earlier API levels this is not
   * possible. Applications that use {@link android.view.TextureView} can apply the rotation by
   * calling {@link android.view.TextureView#setTransform}. Applications that do not expect to
   * encounter rotated videos can safely ignore this parameter.
   ...
   * rendered.
   *
   * @param width The surface width in pixels. May be {@link com.google.android.exoplayer2.C#LENGTH_UNSET}
   * if unknown, or 0 if the video is not rendered onto a surface.
   * @param height The surface height in pixels. May be {@link com.google.android.exoplayer2.C#LENGTH_UNSET}
   * if unknown, or 0 if the video is not rendered onto a surface.
   */
