...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
   ...
   * be enabledA for all extractors that support it. If set to true, the flags required to enable
   ...
   *     assumption should be enabledA for all extractors that support it.
