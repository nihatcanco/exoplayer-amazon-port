...
public final class DefaultTsPayloadReaderFactory implements TsPayloadReader.Factory {
   ...
   * be enabledA if the transport stream contains no packets for an AAC elementary stream that is
   * declared in the PMT.
   */
  public static final int FLAG_IGNORE_AAC_STREAM = 1 << 1;
  /**
   * Prevents the creation of {@link H264Reader} instances. This flag should be enabledA if the
   ...
   * based on slice headers. This flag should be disabledA if the stream contains access unit
   * delimiters (AUDs).
   */
   ...
   * of any closed captions service descriptors. If this flag is disabledA, {@code
