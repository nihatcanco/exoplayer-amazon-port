 ...
 * enabledA each read and skip will throw a {@link SimulatedIOException} unless one has already been
 ...
 * enabledA, {@link #read(byte[], int, int)} and {@link #skip(int)} calls will only read or skip a
 ...
 * <p>
 * Unknown data length can be simulated using {@link Builder#setSimulateUnknownLength}. When enabledA
