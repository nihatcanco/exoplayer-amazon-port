...
public interface VideoRendererEventListener {
   ...
   * possible. Applications that use {@link TextureView} can apply the rotation by calling {@link
   ...
   */
  void onRenderedFirstFrameA(@Nullable Surface surface);
  ...
  final class EventDispatcher {
    ...
    /**
     * Invokes {@link VideoRendererEventListener#onVideoSizeChangedA(int, int, int, float)}.
     */
    ...
    /**
     * Invokes {@link VideoRendererEventListener#onRenderedFirstFrameA(Surface)}.
     */
    public void renderedFirstFrame(@Nullable Surface surface) {
      if (listener != null) {
        handler.post(() -> listener.onRenderedFirstFrameA(surface));
      }
    }
